...
\begin{enumerate}[label=\alph*.]
    ...
    \item Convert $1 0111_2$ to a 16-bit 2's complement integer.\\
    \textbf{First, sign extend $1 0111_2$ to 16 bits. $1 0111_2$ = $1111 1111 1111 0111_2$}
    \newline\textbf{Take the inverse of $1111 1111 1111 0111_2$ = $0000 0000 0000 1000_2$}
    \newline\textbf{Add $1$ to the inverse: $0000 0000 0000 1001_2$}
    \newline\textbf{Convert to decimal and change the sign: $-(1 + 8) = -9_{10}$}
\end{enumerate}
...
\begin{enumerate}[label=\alph*.]
    ...
    \textbf{Convert $240_{10}$ to unsigned binary representation and take 2's complement to change the sign:}
    \newline\textbf{$240_{10} = 128 + 64 + 32 + 16 = 0 1111 0000_2$}
    \newline\textbf{Take an inverse of $0 1111 0000_2 = 1 0000 1111_2$}
    \newline\textbf{Add 1 to find the finalized value: $1 0001 0000_2$}
    ...
    \textbf{The range of numbers that can be represented by 11-bit 2's complement integer is $[-2^{10}, 2^{10}-1]$. $2^{10}-1 = 1023$. Therefore $1171_{10}$ cannot be converted without overflow.}
