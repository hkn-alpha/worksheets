...
\begin{align*}
    Q &= \mu P t \\
    t &= \frac{Q}{\mu P} = \frac{15 \cdot 10^3 \ Wh}{.6 \cdot 500 W}  \\ &= \boxed{50\ \textnormal{hours}}
\end{align*}
...
\begin{align*}
    E_c &= \frac{1}{2}CV^2 \\ 
    &= \frac{1}{2} \cdot (4 \cdot 10^{-9}) \cdot 9 \\
    &= \boxed{1.8 \cdot 10^{-8} \ J}
\end{align*}
...
% Solution steps
\begin{align*}
    E_c &= \frac{1}{2}CV^2 = mgh \\
    V &= \sqrt{\frac{2mgh}{C}} = \sqrt{\frac{2 \cdot .002 \cdot 9.8 \cdot .15}{4 \cdot 10^{-9}}} \\
    &= \boxed{1212.436 \ J}    
\end{align*}
...
% Solution steps
\begin{align*}
    \textnormal{KVL of Bottom Loop: } V_1 &- V_2 - V_4 - V_5 = 0 \\
    V_1 &= V_2 + V_4 + V_5 = 16 + 14 + 20 \\
    V_1 &= \boxed{50 \ V}
\end{align*}
\begin{align*}
    \textnormal{KVL of Bottom Left Loop: } V_1 &- V_2 - V_3 = 0 \\
    V_3 &= V_1 - V_2 =  50 - 16 \\
    V_3 &= \boxed{34 \ V}
\end{align*}
\begin{align*}
    \textnormal{KVL of Top Loop: } V_2 &- V_6 + V_4 = 0 \\
    V_6 &= V_2 + V_4 =  16 + 14 \\
    V_6 &= \boxed{30 \ V}
\end{align*}
\begin{align*}
    \textnormal{KCL at Top Left Node: } I_1 &+ I_2 + I_6 = 0 \\
    I_2 &= -I_1 - I_6 =  -2 - 0 \\
    I_2 &= \boxed{-2 \ A}
\end{align*}
\begin{align*}
    \textnormal{KCL at Center Node: } I_2 &= I_3 + I_4 \\
    I_4 &= I_2 - I_3 = -2-3 \\
    I_4 &= \boxed{-5 \ A}
\end{align*}
\begin{align*}
    \textnormal{KCL at Bottom Node: } I_1 &+ I_3 + I_5 = 0 \\
    I_5 &= -I_1 - I_3 =  -2-3 \\
    I_5 &= \boxed{-5 \ A}
\end{align*}
...
\textbf{Solution:} The 1 Ohm and 3 Ohm resistors are in parallel with the current source. Therefore, the voltage across both resistors is equal to 2V. From here, we can use the voltage divider rule because the resistors are in series.
\begin{align*}
    V_1 &= \frac{1}{1+3} \cdot 2 \\
        &= \boxed{\frac{1}{2} \ V}
\end{align*}
...
Substituting values:
\[
I_1 = 22 \text{ mA} \cdot \frac{2}{2 + 2} = 22 \text{ mA} \cdot \frac{1}{2} = \boxed{11 \text{ mA}.}
\]
...
Thus, the total equivalent resistance is \( \boxed{ R_{\text{eq}} = 6 \, \Omega } \).
\bigskip
